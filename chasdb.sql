...
-- Schema chasdb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `chasdb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `chasdb` ;
...
CREATE TABLE IF NOT EXISTS `chasdb`.`encomendas` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `chaid` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `chasdb`.`chafavorito` (
  ...
  INDEX `fk_chafavorito_users1_idx` (`users_id` ASC),
...
UPDATE chasdb.users SET is_admin = TRUE WHERE id = 1;